...
const features = [
    ...
    { icon: Calendar, title: 'Tax-Loss Harvesting', desc: 'Identify opportunities to offset gains with losses to reduce tax liability.', comingSoon: true },
    { icon: FileText, title: 'Compliance Reports', desc: 'Generate ITR-ready summaries for easy tax filing and documentation.', comingSoon: true },
    { icon: Users, title: 'CA & Pro Features', desc: 'Manage multiple clients, import broker statements, and more professional tools.', comingSoon: true },
...
const Dashboard = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/50 to-slate-900 text-white">
            <div className="relative overflow-hidden pt-24 pb-16 md:pt-32 md:pb-16 flex items-center justify-center">
                <ParticleBackground />
                    ...
                    {features.map((feature, index) => {
                        ...
                        <div key={index} className="p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
                            <div className="flex justify-between items-start">
                                ...
                                {feature.comingSoon && (
                                    <span className="text-xs font-medium bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 px-2.5 py-1 rounded-full">
                                    Coming Soon
                                    </span>
                                )}
                            </div>
